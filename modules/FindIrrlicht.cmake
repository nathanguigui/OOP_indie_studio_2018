...
IF (NOT Irrlicht_INCLUDE_DIRS OR NOT Irrlicht_LIBRARIES)
  FIND_PATH(Irrlicht_INCLUDE_DIRS
    ...
    PATHS
      ...
      ${CMAKE_SOURCE_DIR}/include/ # Expected to contain the path to this file for Windows10
  ...
  FIND_LIBRARY(Irrlicht_LIBRARIES
    ...
    PATHS
      ...
      ${CMAKE_SOURCE_DIR}/         # Expected to contain the path to this file for Windows10
